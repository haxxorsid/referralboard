...
func (a *App) SetUpDB() {
	...
	a.DB.Create(&models.YearsOfExperience{Description: "0 Years/Studen/Intern"})
	...
	a.DB.Create(&models.User{FirstName: "Shashank", LastName: "Kumar", Email: "mailaddress2@companya.com", Password: "root", CurrentLocation: "Florida", CurrentCompanyId: 1, CurrentCompanyName: "Company A", CurrentPosition: "Intern", YearsOfExperienceId: 1, School: "UF"})
	a.DB.Create(&models.User{FirstName: "John", LastName: "Doe", Email: "mailaddress1@companyb.com", Password: "root", CurrentLocation: "California", CurrentCompanyId: 2, CurrentCompanyName: "Company B", CurrentPosition: "Intern", YearsOfExperienceId: 1, School: "UF"})
	a.DB.Create(&models.User{FirstName: "user3", LastName: "demo3", Email: "mailaddress3@companyc.com", Password: "root", CurrentLocation: "California", CurrentCompanyId: 3, CurrentCompanyName: "Company C", CurrentPosition: "Software Engineer", YearsOfExperienceId: 2, School: "UF"})
	a.DB.Create(&models.User{FirstName: "user4", LastName: "demo4", Email: "mailaddress4@gmail.com", Password: "root", CurrentLocation: "California", CurrentCompanyId: 1, CurrentCompanyName: "UF", CurrentPosition: "Student", YearsOfExperienceId: 3, School: "UF"})
